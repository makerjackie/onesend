...
// The upstream UI export includes a gallery picker backed by a photo plugin.
// This fork intentionally exposes only the native/FFI barcode APIs so the
// application does not pull the picker plugin into its iOS target.
